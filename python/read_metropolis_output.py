...
AGENT_INPUT_FILENAME = "./output/runs/3/agents.json"
# Path to the output agent-results file.
AGENT_RESULTS_FILENAME = "./output/runs/3/agent_results.json.zst"
...
SKIM_RESULTS_FILENAME = "./output/runs/3/skim_results.json.zst"
    ...
    data = [
        {
            ...
            "length": l["class"]["value"].get("length"),
    ...
    data = [
        {
            ...
            "vehicle": l["class"]["value"].get("vehicle"),
